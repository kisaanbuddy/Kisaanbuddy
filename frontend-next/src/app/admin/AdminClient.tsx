    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col md:flex-row">
      ...
      >
        ...
        <div className="pt-4 border-t border-border space-y-2.5">
          <div className="p-3 rounded-2xl bg-gradient-to-r from-primary/10 via-emerald-500/10 to-teal-500/10 border border-primary/20 shadow-xs">
            <div className="flex items-center gap-3">
              {currentUser?.profile_image ? (
                ...
                <div className="h-10 w-10 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 text-white flex items-center justify-center font-extrabold text-sm uppercase shadow-xs shrink-0">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[9px] font-extrabold px-1.5 py-0.2 rounded-full bg-primary text-primary-foreground uppercase tracking-wider">
                    Founder
                  </span>
                </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-xl text-xs font-semibold text-destructive hover:bg-destructive/10 transition-colors border border-destructive/20"
          >
      ...
      <main className="flex-1 p-4 md:p-8 max-w-7xl mx-auto w-full">
        ...
        {activeTab === "dashboard" && (
          <div className="space-y-6">
            {/* Founder Welcome VIP Banner */}
            <div className="relative overflow-hidden p-6 rounded-3xl bg-gradient-to-br from-emerald-600 via-teal-600 to-emerald-800 text-white shadow-lg">
              <div className="absolute top-0 right-0 -translate-y-6 translate-x-6 w-52 h-52 bg-white/10 rounded-full blur-2xl pointer-events-none" />
              <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div className="space-y-1.5">
                  <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/15 backdrop-blur-md text-[11px] font-extrabold uppercase tracking-widest text-emerald-100">
                    <Shield className="h-3.5 w-3.5 text-amber-300" />
                    Official Founder & Core Leadership Console
                  </div>
                  ...
                  <p className="text-xs md:text-sm text-emerald-100/90 max-w-xl">
                    You have unrestricted Master Authority over KisaanBuddy. Monitor agricultural telemetry, manage farmer accounts, oversee site communications, and lead the mission.
                  </p>
                </div>
                <div className="flex items-center gap-3 bg-black/20 backdrop-blur-md px-4 py-2.5 rounded-2xl border border-white/10">
                  ...
                  <div className="text-right">
                    <p className="text-[10px] uppercase font-bold text-emerald-200">Security Clearance</p>
                    <p className="text-xs font-black tracking-wide text-white">LEVEL 5 · ROOT ACCESS</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-border pb-4">
              <div>
                <h1 className="text-xl md:text-2xl font-bold tracking-tight">System Telemetry & Health</h1>
                <p className="text-xs text-muted-foreground">
                  Live platform metrics, database telemetry, and real-time user acquisition.
                </p>
              </div>
              <button
              ...
              <table className="w-full text-left text-xs text-foreground">
                ...
                <tbody className="divide-y divide-border">
                  {loadingUsers ? (
                    ...
                    users.map((u) => {
                      const isFounder =
                        u.email === "aditya@kisaanbuddy.com" ||
                        u.email === "utkarsh@kisaanbuddy.com" ||
                        u.email === "yash@kisaanbuddy.com";
                      return (
                        <tr
                          key={u.id}
                          className={`transition-colors ${
                            isFounder
                              ? "bg-gradient-to-r from-emerald-500/5 via-teal-500/5 to-transparent hover:bg-emerald-500/10"
                              : "hover:bg-muted/30"
                          }`}
                        >
                            ...
                            <div className="flex items-center gap-2.5">
                              {u.profile_image ? (
                                <img
                                  src={u.profile_image}
                                  alt={u.name || "User"}
                                  className="h-8 w-8 rounded-full object-cover border border-primary/40 shrink-0"
                                />
                              ) : (
