    ...
    <div className="max-w-4xl mx-auto py-8 px-2 md:px-6">
      ...
      <div className="glass-panel rounded-2xl p-6 md:p-8 space-y-6 text-xs md:text-sm text-muted-foreground leading-relaxed">
        ...
        <section className="space-y-2">
          ...
          <p>
            {t("disclaimer.the_content_is_provided")as is\" and \"as available\" basis. We make no representations or warranties of any kind, express or implied, as to the accuracy, completeness, or reliability of the AI suggestions generated by the system."}
          </p>
        </section>
